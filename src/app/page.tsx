    ...
    <div className="flex flex-col min-h-screen bg-black text-white font-sans selection:bg-purple-500/30">
      ...
      <main className="flex-1">
        ...
        <div className="bg-[#050505] border-t border-white/5 py-6 overflow-hidden flex w-full">
          <div className="animate-marquee whitespace-nowrap flex items-center gap-16 shrink-0 pr-16 text-[15px] text-slate-500">
            ...
            <div className="flex items-center gap-3"><Link2 className="w-5 h-5 text-slate-400"/> Painel e <span className="text-white font-semibold">WhatsApp</span></div>
          </div>
              ...
              <div className="order-2 md:order-1 relative">
                ...
                <div className="glass-card p-10 rounded-[2rem] relative z-10 hover:-translate-y-1 transition-transform duration-500">
                   ...
                   <p className="text-slate-500 mb-8 leading-relaxed text-lg">
                     Esqueça as planilhas complexas. Mande um áudio no trânsito informando o que gastou e o WhatSpent entende, categoriza e salva tudo para você.
                   </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center group">
              <div className="order-2 md:order-1 relative">
                ...
                <div className="glass-card p-10 rounded-[2rem] relative z-10 hover:-translate-y-1 transition-transform duration-500">
                   ...
                   <p className="text-slate-500 mb-8 leading-relaxed text-lg">
                     "Marca dentista amanhã as 9h". Simples assim. O WhatSpent cria o evento para você acompanhar no painel.
                   </p>
                   <ul className="space-y-4">
                      <li className="flex items-center gap-3 font-medium text-slate-700">
        ...
        <section className="py-24 px-6 bg-gradient-to-br from-[#8B5CF6] to-[#6D28D9] text-white">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-white/80 max-w-2xl mx-auto mb-16">
              Mande um áudio de 2 minutos misturando ideias, reuniões e gastos. O WhatSpent quebra tudo em tarefas e lançamentos corretos.
            </p>
        ...
        <section id="cartoes" className="py-32 px-6 bg-[#020617] text-white relative">
          ...
          <div className="container mx-auto max-w-5xl relative z-10 text-center">
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-16 font-light tracking-wide">
              Registre suas compras, organize as parcelas e acompanhe as próximas faturas em um só lugar.
            </p>
            ...
            <div className="glass-card-dark p-10 max-w-3xl mx-auto hover:-translate-y-2 transition-transform duration-500 group">
               <div className="flex flex-col md:flex-row items-center justify-between mb-8 border-b border-white/10 pb-8 gap-6">
                 <div className="flex items-center gap-5">
                   <div className="w-14 h-14 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center font-bold text-xl shadow-[0_0_20px_rgba(16,185,129,0.3)] group-hover:shadow-[0_0_30px_rgba(16,185,129,0.5)] transition-shadow">W</div>
                   <div className="text-left">
                     <h4 className="font-bold text-xl tracking-tight">Seu cartão</h4>
                     <p className="text-sm text-slate-400 font-medium">Compras e parcelas organizadas</p>
                   </div>
                 </div>
                 <div className="text-center md:text-right">
                   <p className="text-sm text-slate-400 font-medium mb-1">Próxima fatura</p>
                   <h4 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-300">Acompanhe pelo painel</h4>
                 </div>
               </div>
               <div className="flex items-center justify-center gap-16 text-slate-300">
                 <div className="text-center group-hover:-translate-y-1 transition-transform delay-75">
                   ...
                   <span className="text-sm font-semibold tracking-wide">Dados sob seu controle</span>
                 </div>
                 <div className="text-center group-hover:-translate-y-1 transition-transform delay-150">
                   ...
                   <span className="text-sm font-semibold tracking-wide">Lançamentos manuais</span>
                 </div>
               </div>
            </div>
          </div>
        ...
        {/* 8. VALIDAÇÃO PÚBLICA */}
        <section className="py-28 px-6 bg-[#F8FAFC] text-slate-900 relative">
          <div className="container mx-auto max-w-4xl text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-100 text-emerald-800 text-xs font-extrabold tracking-wider uppercase mb-6">Acesso gratuito</div>
            <h2 className="text-4xl md:text-6xl font-extrabold text-slate-900 mb-6 tracking-tight">
              Valide o WhatSpent <br/>com a gente.
            </h2>
            <p className="mx-auto max-w-2xl text-lg leading-8 text-slate-600">Durante esta fase, você pode criar sua conta, organizar sua rotina e nos ajudar a melhorar o produto. Não há cobrança nem assinatura.</p>
            <Link href="/cadastro" className="mt-10 inline-flex items-center gap-2 rounded-2xl bg-emerald-700 px-7 py-4 font-semibold text-white shadow-lg shadow-emerald-700/20 transition hover:bg-emerald-800">Criar conta gratuita <ArrowRight className="h-4 w-4" /></Link>
          </div>
        </section>
          ...
          <div className="container mx-auto max-w-3xl">
            ...
            <div className="space-y-4">
              {[
                ...
                {q: "Meus dados estão seguros?", a: "A conta usa confirmação de e-mail, vinculação do número pelo próprio WhatsApp e controles contra uso abusivo. Consulte nossa Política de Privacidade para entender como os dados são tratados."},
                {q: "Posso adicionar outra pessoa na conta?", a: "Os recursos compartilhados estão em evolução. Cada pessoa deve usar sua própria conta e confirmar o próprio número de WhatsApp."},
                {q: "O WhatSpent é pago?", a: "Não durante esta fase de validação. O acesso está gratuito e não há assinatura ativa."},
          ...
          <div className="flex w-max">
            ...
            <div className="animate-marquee flex items-center gap-16 px-8">
              <div className="flex items-center gap-3 shrink-0">
                <span className="text-white font-semibold">Acesso gratuito</span> durante a validação
              </div>
              <div className="flex items-center gap-3 shrink-0">
                ...
                Seu agente <span className="text-white font-semibold">no WhatsApp</span>
              </div>
              <div className="flex items-center gap-3 shrink-0">
                <span className="text-white font-semibold text-lg">$</span>
                <span className="text-white font-semibold">Sua rotina</span> organizada
              </div>
              <div className="flex items-center gap-3 shrink-0">
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                <span className="text-white font-semibold">Você no controle</span> dos seus dados
              </div>
              <div className="flex items-center gap-3 shrink-0">
                <Link2 className="w-5 h-5 text-slate-400"/>
                Painel e <span className="text-white font-semibold">WhatsApp</span> conectados
              </div>
            </div>
      ...
      <footer className="bg-black text-slate-400 py-16 px-6">
        <div className="container mx-auto max-w-6xl grid md:grid-cols-12 gap-12">
          <div className="md:col-span-5">
              ...
              <div className="relative w-12 h-12 flex items-center justify-center">
                <div className="absolute inset-0 bg-white rounded-full flex items-center justify-center">
                  <div className="w-[85%] h-[85%] bg-[#050B14] rounded-full flex items-center justify-center translate-x-[2px] -translate-y-[2px]">
                    <span className="text-white font-black text-3xl italic -translate-x-[2px] translate-y-[1px]">W</span>
                  </div>
                </div>
            ...
            <p className="text-sm max-w-xs leading-relaxed text-slate-400">
              Sua rotina, seus lançamentos e seus projetos organizados no painel e pelo seu agente no WhatsApp.
            </p>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3 text-sm">
              <li><Link href="/entrar" className="hover:text-white transition-colors">Entrar</Link></li>
        ...
        <div className="container mx-auto max-w-6xl mt-16 pt-8 border-t border-white/10 text-xs flex flex-col md:flex-row justify-between items-center gap-4">
          <p>© 2026 WhatSpent. Todos os direitos reservados.</p>
