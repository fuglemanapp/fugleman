    ...
    <main className="min-h-screen bg-[#f4f8f5] px-4 py-10 text-[#17372b] sm:px-6 lg:py-16">
      <article className="mx-auto max-w-3xl rounded-[2rem] border border-[#dcebe2] bg-white p-7 shadow-[0_24px_60px_-44px_rgba(12,100,53,.42)] sm:p-10">
        ...
        <div className="mt-9 space-y-6 text-[15px] leading-relaxed text-[#506e5e]">
          <p>Estes termos regulam o uso do WhatSpent durante a fase de validação gratuita.</p>
          <section><h2 className="text-xl font-semibold tracking-[-.03em] text-[#17372b]">Uso do serviço</h2><p className="mt-2">O WhatSpent permite que você registre informações pelo painel e, após vincular o seu número, por mensagens no WhatsApp. Você é responsável pela veracidade dos dados enviados e por proteger o acesso à sua conta.</p></section>
