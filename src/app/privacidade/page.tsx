    ...
    <main className="min-h-screen bg-[#f4f8f5] px-4 py-10 text-[#17372b] sm:px-6 lg:py-16">
      <article className="mx-auto max-w-3xl rounded-[2rem] border border-[#dcebe2] bg-white p-7 shadow-[0_24px_60px_-44px_rgba(12,100,53,.42)] sm:p-10">
        ...
        <div className="mt-9 space-y-6 text-[15px] leading-relaxed text-[#506e5e]">
          ...
          <section><h2 className="text-xl font-semibold tracking-[-.03em] text-[#17372b]">Login e dados do Google</h2><p className="mt-2">Ao entrar com o Google, tratamos nome, e-mail e foto de perfil da sua Conta do Google para criar e identificar seu acesso. Se você autorizar, também acessamos o Google Calendar (escopos <code>calendar.events</code> e <code>calendar.acls</code>) apenas para sincronizar e gerenciar eventos e permissões de agenda a seu pedido. Você pode revogar esse acesso quando quiser em <a href="https://myaccount.google.com/permissions" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#087d3c] hover:text-[#056c35]">myaccount.google.com/permissions</a>.</p><p className="mt-2">O uso e a transferência de informações recebidas das APIs do Google seguem a <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#087d3c] hover:text-[#056c35]">Política de Dados do Usuário dos Serviços de API do Google</a>, incluindo os requisitos de Uso Limitado (Limited Use). Não usamos esses dados para publicidade, não os vendemos e não os compartilhamos, exceto para operar o serviço, por exigência legal ou com o seu consentimento explícito.</p></section>
