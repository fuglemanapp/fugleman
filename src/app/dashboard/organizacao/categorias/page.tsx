...
export default function OrganizacaoCategoriasPage() {
  ...
  const colorPalette = [
    ...
    '#F97316', // Orange
    '#EAB308', // Yellow
    '#22C55E', // Green (Selected in screenshot)
    '#3B82F6', // Blue
    '#8B5CF6', // Purple
    '#EC4899', // Pink
    '#64748B', // Slate
    ...
    <div className="flex flex-col min-h-screen bg-transparent transition-colors duration-300 dark:bg-[#0B0F19] font-sans text-slate-900">
      ...
      <main className="flex-1 p-4 md:p-8 overflow-auto flex flex-col items-center">
        ...
        <div className="w-full max-w-5xl bg-white rounded-2xl shadow-sm border border-slate-100 p-6 md:p-8 mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl md:text-2xl font-extrabold text-slate-900 mb-1">Categorias e Tags</h1>
            <p className="text-sm text-slate-500">Organize e uniformize suas demandas criando tags e pastas essenciais.</p>
          </div>
          <button
        ...
        <div className="w-full max-w-5xl flex flex-col items-center justify-center py-24 text-center">
          <div className="relative w-24 h-24 bg-gradient-to-br from-purple-100/50 to-indigo-100/50 rounded-full flex items-center justify-center mb-8 shadow-sm">
            ...
            {/* Ícone de Tags Roxo */}
            <Tag className="w-10 h-10 text-[#9333EA] relative z-10" fill="currentColor" fillOpacity="0.2" strokeWidth={1.5} />
          </div>
          <h2 className="text-2xl font-extrabold text-slate-900 mb-3 tracking-tight">Nenhuma categoria encontrada</h2>
          <p className="text-[15px] text-slate-500 max-w-[320px] mx-auto mb-8 leading-relaxed">
            Cadastre categorias para agrupar e organizar suas tarefas e projetos.
          </p>
          <button
            onClick={() => setIsModalOpen(true)}
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-[500px] overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col">
            ...
            <div className="p-8 pb-6 flex items-center gap-4 relative border-b border-slate-100">
              ...
              <div>
                <h2 className="text-xl font-extrabold text-slate-900 leading-tight">Nova Categoria</h2>
                <p className="text-[13px] text-slate-500 mt-1">Crie uma nova categoria para agrupar projetos e tarefas.</p>
              </div>
            </div>
            ...
            <div className="px-8 py-8 flex flex-col gap-6 bg-white">
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] font-bold text-slate-500 tracking-wider uppercase">INFORMAÇÕES DA CATEGORIA</span>
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="Ex: Marketing Visual"
              ...
              <div>
                ...
                <div className="border border-slate-200 rounded-2xl p-5 bg-[#FAFAFA]">
                    ...
                    {colorPalette.map((colorHex) => (
                      <button
                        ...
                        className={`w-8 h-8 rounded-full shadow-sm transition-transform hover:scale-110 ${
                          selectedColor === colorHex ? 'ring-2 ring-offset-2 ring-slate-900 scale-110' : ''
                        }`}
                      />
                    ))}
                  </div>
                  ...
                  <div className="flex items-center border border-slate-200 rounded-xl px-4 py-3 bg-white focus-within:ring-2 focus-within:ring-purple-500/20 focus-within:border-purple-500 transition-all">
                    ...
                    <input
                      ...
                      className="w-full text-slate-700 text-sm font-medium focus:outline-none bg-transparent"
                    />
                    <div 
                      className="w-6 h-6 rounded-md shrink-0 ml-3 shadow-sm border border-slate-100"
                      style={{ backgroundColor: selectedColor }}
                    ></div>
                  </div>
            ...
            {/* Modal Footer */}
            <div className="px-8 pb-8 bg-white flex justify-end">
              <button
                onClick={() => setIsModalOpen(false)}
