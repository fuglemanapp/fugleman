    ...
    <div className="flex flex-col min-h-screen bg-transparent transition-colors duration-300 dark:bg-[#0B0F19] font-sans text-slate-900">
      ...
      <main className="flex-1 p-4 md:p-8 overflow-auto flex flex-col items-center">
        ...
        <div className="w-full max-w-5xl bg-white rounded-2xl shadow-sm border border-slate-100 p-6 md:p-8 mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl md:text-2xl font-extrabold text-slate-900 mb-1">Projetos</h1>
            <p className="text-sm text-slate-500">Gerencie e monitore o avanço dos seus projetos de alto nível.</p>
          </div>
          <button
        ...
        <div className="w-full max-w-5xl flex flex-col items-center justify-center py-24 text-center">
          <div className="relative w-24 h-24 bg-gradient-to-br from-purple-100/50 to-indigo-100/50 rounded-full flex items-center justify-center mb-8 shadow-sm">
            <div className="absolute inset-0 bg-white/40 rounded-full backdrop-blur-sm"></div>
            {/* Ícone de Layers (Camadas) Roxo */}
            <Layers className="w-10 h-10 text-[#9333EA] relative z-10" fill="currentColor" fillOpacity="0.2" strokeWidth={1.5} />
          </div>
          <h2 className="text-2xl font-extrabold text-slate-900 mb-3 tracking-tight">Nenhum projeto encontrado</h2>
          <p className="text-[15px] text-slate-500 max-w-[320px] mx-auto mb-8 leading-relaxed">
            Cadastre novos projetos para agrupar suas tarefas e acompanhar o progresso global.
          </p>
          <button
            onClick={() => setIsModalOpen(true)}
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-[600px] overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col">
            ...
            <div className="p-8 pb-6 flex items-center gap-4 relative border-b border-slate-100">
              ...
              <div className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0 bg-indigo-50 text-indigo-500 border border-indigo-100">
                <Layers className="w-6 h-6" />
              </div>
              <div>
                <h2 className="text-xl font-extrabold text-slate-900 leading-tight">Novo Projeto</h2>
                <p className="text-[13px] text-slate-500 mt-1">Crie um novo projeto para agrupar suas tarefas.</p>
              </div>
            </div>

            {/* Modal Body */}
            <div className="px-8 py-8 flex flex-col gap-6 bg-[#FAFAFA]">

              <div className="flex items-center gap-2 mb-2">
                <div className="w-1.5 h-1.5 rounded-full bg-[#9333EA]"></div>
                <span className="text-[10px] font-bold text-slate-500 tracking-wider uppercase">INFORMAÇÕES DO PROJETO</span>
              </div>

              <div>
                <label className="block text-[11px] font-bold text-slate-700 tracking-wider mb-2 uppercase">NOME DO PROJETO</label>
                <input
                  type="text"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-28 border border-slate-200 rounded-xl px-4 py-3 text-slate-800 font-medium focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all bg-white resize-none"
                ></textarea>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    <select className="w-full appearance-none border border-slate-200 rounded-xl px-4 py-3 text-slate-800 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-purple-500/20 transition-all bg-white cursor-pointer">
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-700 tracking-wider mb-2 uppercase">PRAZO / DEADLINE</label>
            ...
            <div className="px-8 pb-8 bg-[#FAFAFA] flex justify-end">
              ...
              >
                <Check className="w-4 h-4" /> Salvar Projeto
              </button>
            </div>
