...
export default function AjudaArtigoOpenFinancePage() {
  return (
      ...
      <main className="flex-1 p-4 md:p-8 flex flex-col items-center">
        ...
        <div className="w-full max-w-4xl flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3 theme-text-secondary text-xs font-medium px-2 py-4 mb-2">
            ...
            <span>{'>'}</span>
            <span className="theme-text-primary font-bold">Como conectar sua conta ao Open Financ...</span>
          </div>
          ...
          <div className="theme-bg-card rounded-[2rem] p-8 md:p-12 shadow-sm border theme-border transition-colors duration-300">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="flex items-center gap-2 px-3 py-1 bg-[#1E1B4B]/60 dark:bg-indigo-900/30 text-indigo-400 text-[10px] font-bold rounded-md uppercase tracking-wider border border-indigo-500/20">
                <CreditCard className="w-3.5 h-3.5" /> FINANÇAS
              </div>
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold theme-text-primary mb-12 tracking-tight">Como conectar sua conta ao Open Finance?</h1>

            <div className="space-y-8 theme-text-secondary text-[15px] leading-relaxed">
              <p>Como conectar sua conta ao Open Finance?</p>

              <div>
                <p className="font-bold theme-text-primary text-base mb-1">Resposta rápida:</p>
                <p>Acesse integrações, inicie a conexão e autorize pelo seu banco via QR Code.</p>
              </div>

              <div>
                <p className="mb-2">Passo a passo</p>
                <p>Acesse <span className="font-bold theme-text-primary">app.meuassessor.com</span></p>
                <p>Vá em <span className="font-bold theme-text-primary">Financeiro &gt; Integrações</span></p>
                <p>Clique em <span className="font-bold theme-text-primary">Adicionar conexão Open Finance</span></p>
                <p>Informe seu <span className="font-bold theme-text-primary">CPF</span> e selecione o <span className="font-bold theme-text-primary">banco</span></p>
                <p>Escaneie o <span className="font-bold theme-text-primary">QR Code</span> exibido</p>
                <p>Autorize a conexão no aplicativo do seu banco</p>
              </div>

              <div>
                <p className="mb-2">Importante</p>
                <p>A autorização é feita <span className="font-bold theme-text-primary">diretamente no seu banco</span></p>
                <p>Sem essa autorização, a conexão não é concluída</p>
                <p>A conexão pode levar alguns minutos para começar a sincronizar</p>
              </div>

              <div>
                <p className="mb-2">Sobre segurança</p>
                <p>O acesso é feito via padrão do <span className="font-bold theme-text-primary">Open Finance</span></p>
                <p>O sistema <span className="font-bold theme-text-primary">não movimenta dinheiro</span>, apenas lê dados autorizados</p>
              </div>

              <div>
                <p className="mb-2">Se não funcionar</p>
                <p>Verifique se o app do banco está atualizado</p>
                <p>Refaça o processo de autorização</p>
                <p>Confirme se escolheu o banco correto</p>
              </div>
          ...
          {/* Artigos Relacionados (Vazio conforme design) */}
