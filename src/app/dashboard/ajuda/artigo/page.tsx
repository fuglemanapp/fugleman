...
export default function AjudaArtigoPage() {
  return (
      ...
      <main className="flex-1 p-4 md:p-8 flex flex-col items-center">
        ...
        <div className="w-full max-w-4xl flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3 theme-text-secondary text-xs font-medium px-2 py-4 mb-2">
            ...
            <span>{'>'}</span>
            <span className="theme-text-primary font-bold">Sincronizando com Google Agenda</span>
          </div>
          ...
          <div className="theme-bg-card rounded-[2rem] p-8 md:p-12 shadow-sm border theme-border transition-colors duration-300">
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold theme-text-primary mb-12 tracking-tight">Sincronizando com Google Agenda</h1>

            <div className="space-y-8 theme-text-secondary text-[15px] leading-relaxed">
              <p>Como conectar sua agenda do Google?</p>

              <div>
                <p className="font-bold theme-text-primary text-base mb-1">Resposta rápida:</p>
                <p>Acesse as integrações de agenda, conecte sua conta Google e escolha como os calendários serão sincronizados.</p>
              </div>

              <div>
                <p className="mb-2">Passo a passo</p>
                <ul className="space-y-1">
                  <li>Vá em <span className="font-bold theme-text-primary">Agenda &gt; Integrações</span></li>
                  <li>Clique em <span className="font-bold theme-text-primary">Conectar Google Agenda</span></li>
              ...
              <div>
                <p className="mb-2">Configurações após conectar</p>
                <p className="mb-1">Você precisa definir como a integração vai funcionar:</p>
                
                <p className="font-bold theme-text-primary mt-4">Selecionar calendários</p>
                <p>Escolha quais calendários serão sincronizados (caso tenha mais de um no Google)</p>
                
                <p className="font-bold theme-text-primary mt-4">Sincronização</p>
                <p>Apenas importar eventos do Google</p>
                <p>Ou sincronização em <span className="font-bold theme-text-primary">mão dupla</span> (eventos do sistema também vão para o Google)</p>
                
                <p className="font-bold theme-text-primary mt-4">Calendário padrão</p>
                <p>Define onde novos compromissos serão criados</p>
                
                <p className="font-bold theme-text-primary mt-4">Conta padrão</p>
                <p>Define qual conta será usada por padrão ao criar eventos</p>
              </div>

              <div>
                <p className="mb-2">Importante</p>
                <p>A sincronização <span className="font-bold theme-text-primary">não é instantânea</span> — pode levar alguns minutos</p>
                <p>Se não configurar corretamente, eventos podem não aparecer ou não sincronizar como esperado</p>
              </div>

              <div>
                <p className="mb-2">Privacidade</p>
                <p>Apenas <span className="font-bold theme-text-primary">título e horário</span> dos eventos são importados</p>
                <p>Outros dados permanecem na sua conta Google</p>
              </div>

              <div>
                <p className="mb-2">Se algo estiver errado</p>
                <ul className="space-y-1">
                  <li>Verifique se a conta Google correta foi conectada</li>
                  <li>Confirme quais calendários estão selecionados</li>
                  <li>Revise se a sincronização está ativada corretamente</li>
                  <li>Se ainda não funcionar, envie um e-mail detalhando o erro para contato@meuassessor.com</li>
                </ul>
              </div>
            </div>
