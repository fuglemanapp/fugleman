...
export default function AjudaArtigoOutrosPage() {
  return (
      ...
      <main className="flex-1 p-4 md:p-8 flex flex-col items-center">
        ...
        <div className="w-full max-w-4xl flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3 theme-text-secondary text-xs font-medium px-2 py-4 mb-2">
            ...
            <span>{'>'}</span>
            <span className="hover:theme-text-primary cursor-pointer transition-colors">Outros</span>
            <span>{'>'}</span>
            <span className="theme-text-primary font-bold">Como usar o Drive?</span>
          </div>
          ...
          <div className="theme-bg-card rounded-[2rem] p-8 md:p-12 shadow-sm border theme-border transition-colors duration-300">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="flex items-center gap-2 px-3 py-1 bg-[#8B5CF6]/10 text-[#8B5CF6] text-[10px] font-bold rounded-md uppercase tracking-wider border border-purple-500/20">
                <Shield className="w-3.5 h-3.5" /> OUTROS
              </div>
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold theme-text-primary mb-12 tracking-tight">Como usar o Drive?</h1>

            <div className="space-y-8 theme-text-secondary text-[15px] leading-relaxed">
              <p>Como usar o Drive?</p>

              <div>
                <p className="font-bold theme-text-primary mb-1">Resposta rápida:</p>
                <p>Armazene e organize arquivos dentro do sistema, com opção de pastas e compartilhamento.</p>
              </div>

              <div>
                <p className="mb-2">Como usar</p>
                <p>Vá em <span className="font-bold theme-text-primary">Organização &gt; Drive</span></p>
                <p>Faça upload de arquivos ou documentos</p>
                <p>Crie <span className="font-bold theme-text-primary">pastas</span> para organizar</p>
                <p>Use a opção de <span className="font-bold theme-text-primary">compartilhar</span> quando necessário</p>
              </div>

              <div>
                <p className="mb-2">Para que serve</p>
                <p>Guardar documentos e históricos</p>
                <p>Centralizar arquivos em um só lugar</p>
              </div>

              <div>
                <p className="mb-2">Observação</p>
                <p>O Drive é apenas para armazenamento — não edita arquivos internamente</p>
              </div>
            </div>
