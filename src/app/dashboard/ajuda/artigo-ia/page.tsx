...
export default function AjudaArtigoIaPage() {
  return (
      ...
      <main className="flex-1 p-4 md:p-8 flex flex-col items-center">
        ...
        <div className="w-full max-w-4xl flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3 theme-text-secondary text-xs font-medium px-2 py-4 mb-2">
            ...
            <span>{'>'}</span>
            <span className="hover:theme-text-primary cursor-pointer transition-colors">IA</span>
            <span>{'>'}</span>
            <span className="theme-text-primary font-bold">Como falar com a IA Assistente</span>
          </div>
          ...
          <div className="theme-bg-card rounded-[2rem] p-8 md:p-12 shadow-sm border theme-border transition-colors duration-300">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="flex items-center gap-2 px-3 py-1 bg-[#8B5CF6]/10 text-[#8B5CF6] text-[10px] font-bold rounded-md uppercase tracking-wider border border-purple-500/20">
              ...
              <div className="flex items-center gap-1.5 px-3 py-1 theme-bg-elevated theme-text-secondary text-[10px] font-bold rounded-md">
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> 2
              </div>
            </div>

            <h1 className="text-3xl md:text-4xl font-extrabold theme-text-primary mb-12 tracking-tight">Como falar com a IA Assistente</h1>

            <div className="space-y-8 theme-text-secondary text-[15px] leading-relaxed">
              <p>Como usar o assistente pelo WhatsApp?</p>

              <div>
                <p className="font-bold theme-text-primary mb-1">O que você pode fazer:</p>
                <p>Consultar gastos</p>
                <p>Ex: "Quanto gastei com Uber mês passado?"</p>
                <p>Ver previsões</p>
                <p>Ex: "Qual minha previsão de gastos para semana que vem?"</p>
                <p>Pedir sugestões</p>
                <p>Ex: "Como posso economizar em alimentação?"</p>
              </div>

              <div>
                <p>Como criar um lembrete?</p>
              </div>

              <div>
                <p className="font-bold theme-text-primary mb-1">Resposta rápida:</p>
                <p>Envie uma mensagem informando o compromisso, horário e, se quiser, o tempo de antecedência.</p>
              </div>

              <div>
                <p className="font-bold theme-text-primary mb-1">Exemplo básico:</p>
                <p>"Me lembre do meu compromisso às 20:00 com a família"</p>
                <p className="font-bold theme-text-primary mt-2 mb-1">Padrão do sistema:</p>
                <p>O lembrete é enviado <span className="font-bold theme-text-primary">30 minutos antes</span></p>
                <p className="font-bold theme-text-primary mt-2 mb-1">Alterar antecedência:</p>
                <p>"Me lembre do meu compromisso às 20:00 com a família, me lembre 1 hora antes"</p>
              </div>

              <div>
                <p className="mb-2">Lembretes recorrentes</p>
                <p className="font-bold theme-text-primary mb-1">Exemplos:</p>
                <p>"Me lembre todo dia 5 de pagar a fatura de água"</p>
                <p>"Me lembre toda quarta-feira de treinar"</p>
                <p>"Me lembre a cada 20 dias de revisar contas"</p>
              </div>

              <div>
                <p className="mb-2">Limitações importantes</p>
                <p>Se o horário solicitado já estiver dentro do intervalo padrão (ex: faltam 20 minutos e o padrão é 30), <span className="font-bold theme-text-primary">o lembrete não será enviado</span></p>
                <p>O sistema depende da forma como a mensagem é escrita — mensagens muito vagas podem não ser interpretadas corretamente</p>
              </div>

              <div>
                <p className="mb-2">Se não funcionar</p>
                <p>Revise a mensagem enviada (horário, data e clareza)</p>
                <p>Tente reformular de forma mais direta</p>
                <p>Persistindo o erro: WhatsApp (47) 99292-1005 ou contato@meuassessor.com</p>
              </div>
            </div>
