...
export default function AjudaArtigoTarefasPage() {
  return (
      ...
      <main className="flex-1 p-4 md:p-8 flex flex-col items-center">
        ...
        <div className="w-full max-w-4xl flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3 theme-text-secondary text-xs font-medium px-2 py-4 mb-2">
            ...
            <span>{'>'}</span>
            <span className="theme-text-primary font-bold">Como funciona a aba de tarefas!</span>
          </div>
          ...
          <div className="theme-bg-card rounded-[2rem] p-8 md:p-12 shadow-sm border theme-border transition-colors duration-300">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="flex items-center gap-2 px-3 py-1 bg-[#8B5CF6]/10 text-[#8B5CF6] text-[10px] font-bold rounded-md uppercase tracking-wider">
                <Receipt className="w-3.5 h-3.5" /> AGENDA
              </div>
              <div className="flex items-center gap-1.5 px-3 py-1 theme-bg-elevated theme-text-secondary text-[10px] font-bold rounded-md">
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> 3 min
              </div>
            </div>

            <h1 className="text-3xl md:text-4xl font-extrabold theme-text-primary mb-12 tracking-tight">Como funciona a aba de tarefas!</h1>

            <div className="space-y-8 theme-text-secondary text-[15px] leading-relaxed">
              <p>Como funciona a aba de tarefas?</p>

              <div>
                <p className="font-bold theme-text-primary text-base mb-1">Resposta rápida:</p>
                <p>É um gerenciador de tarefas para controlar o que precisa ser feito, com prazos, responsáveis e status.</p>
              </div>

              <div>
                <p className="mb-2">Como criar uma tarefa</p>
                <p>Vá em <span className="font-bold theme-text-primary">Organização &gt; Tarefas</span></p>
                <p>Clique em <span className="font-bold theme-text-primary">Nova tarefa</span></p>
                <p>Preencha as informações</p>
              </div>

              <div>
                <p className="mb-2">O que você pode configurar</p>
                <p><span className="font-bold theme-text-primary">Nome da tarefa</span></p>
                <p><span className="font-bold theme-text-primary">Descrição</span> (detalhes do que precisa ser feito)</p>
                <p><span className="font-bold theme-text-primary">Responsável</span> (pessoa ou equipe)</p>
                <p><span className="font-bold theme-text-primary">Projeto</span> (opcional)</p>
                ...
                <p><span className="font-bold theme-text-primary">Data de lembrete</span></p>
                <p><span className="font-bold theme-text-primary">Status</span> (ex: pendente, em andamento, concluído)</p>
                <p><span className="font-bold theme-text-primary">Urgência</span></p>
              </div>

              <div>
                <p className="mb-2">Como usar no dia a dia</p>
                <p>Acompanhe suas tarefas pela lista</p>
                <p>Atualize o status conforme o andamento</p>
                <p>Use prazos e lembretes para não esquecer atividades</p>
              </div>

              <div>
                <p className="mb-2">Erros comuns (evite)</p>
                <p>Criar tarefa sem responsável</p>
                <p>Não definir prazo</p>
                <p>Não atualizar o status</p>
                <p>Criar tarefas sem descrição clara</p>
              </div>

              <div>
                <p className="mb-2">Resultado esperado</p>
                <p>Controle claro do que precisa ser feito</p>
                <p>Visão de prazos e prioridades</p>
                <p>Menos tarefas esquecidas</p>
              </div>

              <div>
                <p className="mb-2">Se algo não aparecer ou não salvar</p>
                <p>Verifique se todos os campos obrigatórios foram preenchidos</p>
                <p>Atualize a página e tente novamente</p>
              </div>

              <div className="pt-4">
                <p>Se persistir: WhatsApp (47) 992921005 ou contato@meuassessor.com</p>
              </div>
            </div>
          ...
          <div className="theme-bg-card rounded-[2rem] p-8 md:p-12 shadow-sm border theme-border transition-colors duration-300 mt-2">
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="/dashboard/ajuda/artigo-projetos" className="theme-bg-elevated p-5 rounded-2xl flex flex-col border border-transparent hover:theme-border-strong transition-colors group">
                <span className="text-[10px] font-bold theme-text-secondary tracking-wider uppercase flex items-center gap-1.5 mb-2"><BookOpen className="w-3 h-3"/> AGENDA</span>
                <span className="font-semibold theme-text-primary group-hover:text-[#8B5CF6] transition-colors">Como usar os projetos na aba de organização?</span>
              </a>
