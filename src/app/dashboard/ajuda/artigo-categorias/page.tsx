...
export default function AjudaArtigoCategoriasPage() {
  return (
      ...
      <main className="flex-1 p-4 md:p-8 flex flex-col items-center">
        ...
        <div className="w-full max-w-4xl flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3 theme-text-secondary text-xs font-medium px-2 py-4 mb-2">
            ...
            <span>{'>'}</span>
            <span className="theme-text-primary font-bold">Como criar categorias personalizadas</span>
          </div>
          ...
          <div className="theme-bg-card rounded-[2rem] p-8 md:p-12 shadow-sm border theme-border transition-colors duration-300">
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold theme-text-primary mb-12 tracking-tight">Como criar categorias personalizadas</h1>

            <div className="space-y-8 theme-text-secondary text-[15px] leading-relaxed">
              <p>Por que categorizar?</p>

              <div>
                <p>Categorizar suas transações é fundamental para um bom controle financeiro. Ao agrupar seus gastos, você consegue visualizar exatamente para onde seu dinheiro está indo.</p>
              </div>

              <div>
                <p className="mb-2">Passo a Passo</p>
                <p>Acesse o menu <span className="font-bold theme-text-primary">Financeiro &gt; Minhas Categorias</span>.</p>
                <p>Clique no botão <span className="font-bold theme-text-primary">Nova Categoria</span> no canto superior direito.</p>
                <p>Escolha um ícone e uma cor para representar a categoria.</p>
                <p>Defina um nome claro (ex: "Assinaturas de TV").</p>
                <p>Clique em <span className="font-bold theme-text-primary">Salvar</span>.</p>
              </div>

              <div>
                <p className="mb-2">Dica Pro</p>
                <p>Você pode criar subcategorias para um controle ainda mais detalhado.</p>
              </div>

              <div>
                <p className="mb-2">Editando ou Excluindo</p>
                <p>Para editar, basta clicar no ícone de lápis ao lado da categoria desejada. Para excluir, recorro ao ícone de lixeira. Lembre-se que excluir uma categoria removerá a classificação das transações associadas a ela.</p>
              </div>
            </div>
          ...
          {/* Artigos Relacionados (Vazio conforme print da tela de Conciliacao) */}
