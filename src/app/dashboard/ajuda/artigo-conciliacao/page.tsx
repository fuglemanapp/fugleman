...
export default function AjudaArtigoConciliacaoPage() {
  return (
      ...
      <main className="flex-1 p-4 md:p-8 flex flex-col items-center">
        ...
        <div className="w-full max-w-4xl flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3 theme-text-secondary text-xs font-medium px-2 py-4 mb-2">
            ...
            <span>{'>'}</span>
            <span className="theme-text-primary font-bold">Conciliação Bancária: O que é e como f...</span>
          </div>
          ...
          <div className="theme-bg-card rounded-[2rem] p-8 md:p-12 shadow-sm border theme-border transition-colors duration-300">
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div className="flex items-center gap-1.5 px-3 py-1 theme-bg-elevated theme-text-secondary text-[10px] font-bold rounded-md">
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> 5
              </div>
            </div>

            <h1 className="text-3xl md:text-4xl font-extrabold theme-text-primary mb-12 tracking-tight">Conciliação Bancária: O que é e como fazer</h1>

            <div className="space-y-8 theme-text-secondary text-[15px] leading-relaxed">
              <p>Como fazer a conciliação bancária?</p>

              <div>
                <p className="font-bold theme-text-primary text-base mb-1">Resposta rápida:</p>
                <p>Compare suas transações com o extrato do banco e marque como conciliado o que estiver correto.</p>
              </div>

              <div>
                <p className="mb-2">Passo a passo</p>
                <p>Vá em <span className="font-bold theme-text-primary">Financeiro &gt; Transações</span></p>
                <p>Compare as transações com o extrato do seu banco</p>
                <p>Para cada transação correta, clique no <span className="font-bold theme-text-primary">ícone de check (✔)</span> para marcar como conciliada</p>
              </div>

              <div>
                <p className="mb-2">Quando faltar uma transação</p>
                <p>Adicione manualmente a transação que não aparece</p>
                <p>Use os mesmos dados do extrato (valor, data e descrição)</p>
              </div>

              <div>
                <p className="mb-2">O que significa "conciliado"</p>
                <p>A transação foi conferida e bate com o banco</p>
                <p>Evita duplicidade e erros no saldo</p>
              </div>

              <div>
                <p className="mb-2">Erros comuns (evite)</p>
                <p>Marcar como conciliado sem conferir com o extrato</p>
                <p>Ignorar transações faltantes</p>
                <p>Manter valores ou datas diferentes do banco</p>
              </div>

              <div>
                <p className="mb-2">Resultado esperado</p>
                <p>Saldo do sistema igual ao saldo do banco</p>
                <p>Controle financeiro sem inconsistências</p>
              </div>

              <div>
                <p className="mb-2">Se os valores não baterem</p>
                <p>Revise todas as transações do período</p>
                <p>Verifique duplicidade ou lançamentos errados</p>
                <p>Confirme se não há movimentações não registradas</p>
                <p>Se ainda houver diferença: envie para o e-mail contato@meuassessor.com</p>
              </div>
            </div>
