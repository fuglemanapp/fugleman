    ...
    <div className="flex flex-col min-h-screen theme-bg-main font-sans theme-text-primary transition-colors duration-300">
      ...
      <header className="theme-bg-header border-b theme-border-strong transition-colors duration-300 h-14 flex items-center px-4 md:px-6 justify-between shrink-0 sticky top-0 z-50">
        ...
        <div className="flex items-center gap-4 text-slate-400">
          ...
          <a href="/dashboard/ajuda" className="p-1 theme-text-primary transition-colors">
      ...
      <main className="flex-1 p-4 md:p-8 overflow-auto flex flex-col items-center">
        ...
        <div className="w-full max-w-5xl">
          {/* HERO SECTION DA AJUDA */}
          <div className="theme-bg-card rounded-[2.5rem] shadow-sm border theme-border transition-colors duration-300 p-12 md:p-16 mb-12 flex flex-col items-center text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-100/50 dark:bg-blue-500/10 text-blue-700 dark:text-blue-400 text-[10px] font-bold tracking-widest uppercase mb-8">
              CENTRAL DE AJUDA
            </div>
            
            <h1 className="text-4xl md:text-5xl font-extrabold theme-text-primary mb-6 tracking-tight">
              Como podemos <span className="text-[#8B5CF6]">ajudar você?</span>
            </h1>
            
            <p className="text-lg theme-text-secondary max-w-2xl mx-auto mb-10 leading-relaxed">
              Encontre guias rápidos, tutoriais e respostas para suas dúvidas sobre o Meu Assessor.
            </p>

            <div className="w-full max-w-2xl relative mb-10">
              <Search className="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 theme-text-secondary" />
              <input 
                type="text" 
                placeholder="Busque por artigos (ex: 'categorias', 'fatura'...)" 
                className="w-full theme-bg-elevated border theme-border-strong rounded-2xl pl-14 pr-6 py-5 theme-text-primary font-medium focus:outline-none focus:ring-2 focus:ring-[#8B5CF6]/20 transition-all placeholder:text-slate-400 dark:placeholder:text-slate-500"
              />
            </div>

            <div className="flex flex-wrap justify-center gap-3">
              <button className="px-6 py-2.5 bg-white dark:bg-[#F8FAFC] text-slate-900 font-semibold text-sm rounded-full shadow-sm">Todos</button>
              <button className="px-6 py-2.5 theme-bg-elevated theme-text-secondary hover:theme-text-primary font-medium text-sm rounded-full transition-colors border theme-border-strong">Agenda</button>
              <button className="px-6 py-2.5 theme-bg-elevated theme-text-secondary hover:theme-text-primary font-medium text-sm rounded-full transition-colors border theme-border-strong">Dashboard</button>
              <button className="px-6 py-2.5 theme-bg-elevated theme-text-secondary hover:theme-text-primary font-medium text-sm rounded-full transition-colors border theme-border-strong">Finanças</button>
              <button className="px-6 py-2.5 theme-bg-elevated theme-text-secondary hover:theme-text-primary font-medium text-sm rounded-full transition-colors border theme-border-strong">IA</button>
              <button className="px-6 py-2.5 theme-bg-elevated theme-text-secondary hover:theme-text-primary font-medium text-sm rounded-full transition-colors border theme-border-strong">Outros</button>
            </div>
          </div>

          {/* SEÇÃO: AGENDA */}
          <div className="mb-16">
            <h2 className="text-3xl font-extrabold theme-text-primary mb-8 tracking-tight">Agenda</h2>
            <div className="grid md:grid-cols-3 gap-6">
              
              <a href="/dashboard/ajuda/artigo" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <Calendar className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Sincronizando com Google Agenda</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Como conectar sua agenda do Google? Resposta rápida: Acesse as integrações de agenda, conecte sua conta Google e...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>

              <a href="/dashboard/ajuda/artigo-tarefas" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <Receipt className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Como funciona a aba de tarefas!</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Como funciona a aba de tarefas? Resposta rápida: É um gerenciador de tarefas para controlar o que precisa ser...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>

              <a href="/dashboard/ajuda/artigo-projetos" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <FileText className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Como usar os projetos na aba de organização?</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Como usar projetos na aba de organização? Resposta rápida: Projetos servem para agrupar tarefas relacionad...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>

              <a href="/dashboard/ajuda/artigo-notas" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <FileText className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Como usar as Notas?</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Como usar as Notas? Resposta rápida: Crie anotações livres e, quando quiser, transforme em tarefas com um clique...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>

              <a href="/dashboard/ajuda/artigo-relatorios" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <FileText className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Como usar os relatórios da organização?</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Como usar os relatórios da organização? Resposta rápida: Acesse os relatórios, escolha o tipo e exporte em PDF ou Excel...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>

              <a href="/dashboard/ajuda/artigo-organizacao" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <FileText className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Como funciona a aba de organização?</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Como funciona a aba de organização? Resposta rápida: A aba de organização centraliza tarefas, projetos, arquivos...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>
          ...
          {/* SEÇÃO: DASHBOARD */}
          <div className="mb-16">
            <h2 className="text-3xl font-extrabold theme-text-primary mb-8 tracking-tight">Dashboard</h2>
            <div className="grid md:grid-cols-3 gap-6">
              
              <a href="/dashboard/ajuda/artigo-exportar" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <FileText className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Exportando Relatórios em PDF</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Como exportar um relatório financeiro? Passo a passo: Vá em Financeiro &gt; Relatórios Escolha o tipo de relatório: Po...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>
          ...
          {/* SEÇÃO: FINANÇAS */}
          <div className="mb-16">
            <h2 className="text-3xl font-extrabold theme-text-primary mb-8 tracking-tight">Finanças</h2>
            <div className="grid md:grid-cols-3 gap-6">
              
              <a href="/dashboard/ajuda/artigo-categorias" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <BarChart3 className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Como criar categorias personalizadas</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Por que categorizar? Categorizar suas transações é fundamental para um bom controle financeiro. Ao agrupar seus...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>

              <a href="/dashboard/ajuda/artigo-conciliacao" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <BarChart3 className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Conciliação Bancária: O que é e como fazer</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Como fazer a conciliação bancária? Resposta rápida: Compare suas transações com o extrato do banco e...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>

              <a href="/dashboard/ajuda/artigo-cartoes" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <BarChart3 className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Gerenciando Cartões de Crédito</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Como organizar corretamente seus cartões? Configuração inicial (obrigatório) Cadastre cada cartão Informe: Dia de...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>

              <a href="/dashboard/ajuda/artigo-openfinance" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <CreditCard className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Como conectar sua conta ao Open Finance?</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Como conectar sua conta ao Open Finance? Resposta rápida: Acesse integrações, inicie a conexão e autorize...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>

              <a href="/dashboard/ajuda/artigo-conciliacao-of" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <CreditCard className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Como funcionam as conciliações com Open Finance?</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Como funcionam as conciliações com Open Finance? Resposta rápida: O sistema compara automaticamente as transaçõe...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>

              <a href="/dashboard/ajuda/artigo-bancos" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <BarChart3 className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Como funcionam as contas bancárias?</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Como funcionam as contas bancárias? Resposta rápida: As contas servem para separar e controlar saldos e transaçõe...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>
          ...
          {/* SEÇÃO: IA */}
          <div className="mb-16">
            <h2 className="text-3xl font-extrabold theme-text-primary mb-8 tracking-tight">IA</h2>
            <div className="grid md:grid-cols-3 gap-6">
              
              <a href="/dashboard/ajuda/artigo-ia" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <Bot className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Como falar com a IA Assistente</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Como usar o assistente pelo WhatsApp? O que você pode fazer: Consultar gastos Ex: "Quanto gastei com Uber mês passado?...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>
          ...
          {/* SEÇÃO: OUTROS */}
          <div className="mb-16">
            <h2 className="text-3xl font-extrabold theme-text-primary mb-8 tracking-tight">Outros</h2>
            <div className="grid md:grid-cols-3 gap-6">
              
              <a href="/dashboard/ajuda/artigo-outros" className="theme-bg-card rounded-[2rem] p-8 shadow-sm border theme-border transition-colors duration-300 flex flex-col hover:-translate-y-1 hover:shadow-md cursor-pointer group block">
                <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6">
                  <Shield className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold theme-text-primary mb-3 leading-snug">Como usar o Drive?</h3>
                <p className="text-[13px] theme-text-secondary leading-relaxed mb-6 flex-1">
                  Como usar o Drive? Resposta rápida: Armazene e organize arquivos dentro do sistema, com opção de pastas e...
                </p>
                <span className="text-sm font-semibold text-[#8B5CF6] group-hover:text-purple-400 transition-colors mt-auto">Ler artigo</span>
              </a>
