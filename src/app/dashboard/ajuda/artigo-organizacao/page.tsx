...
export default function AjudaArtigoOrganizacaoPage() {
  return (
      ...
      <main className="flex-1 p-4 md:p-8 flex flex-col items-center">
        ...
        <div className="w-full max-w-4xl flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3 theme-text-secondary text-xs font-medium px-2 py-4 mb-2">
            ...
            <span>{'>'}</span>
            <span className="theme-text-primary font-bold">Como funciona a aba de organização?</span>
          </div>
          ...
          <div className="theme-bg-card rounded-[2rem] p-8 md:p-12 shadow-sm border theme-border transition-colors duration-300">
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold theme-text-primary mb-12 tracking-tight">Como funciona a aba de organização?</h1>

            <div className="space-y-8 theme-text-secondary text-[15px] leading-relaxed">
              <p>Como funciona a aba de organização?</p>

              <div>
                <p className="font-bold theme-text-primary text-base mb-1">Resposta rápida:</p>
                <p>A aba de organização centraliza tarefas, projetos, arquivos, notas e relatórios em um único lugar.</p>
              </div>

              <div>
                <p className="mb-2">Funções disponíveis</p>
                
                <p className="font-bold theme-text-primary">Tarefas</p>
                <p className="mb-4">Criação e controle de atividades com prazo, responsável, status e prioridade</p>
                
                <p className="font-bold theme-text-primary">Projetos</p>
                <p className="mb-4">Agrupam tarefas relacionadas para organizar por contexto (ex: trabalho, estudo)</p>
                
                <p className="font-bold theme-text-primary">Notas</p>
                <p className="mb-4">Anotações livres que podem ser convertidas em tarefas com um clique</p>
                
                <p className="font-bold theme-text-primary">Drive</p>
                <p className="mb-4">Armazenamento de arquivos, com pastas e opção de compartilhamento</p>
                
                <p className="font-bold theme-text-primary">Relatórios</p>
                <p>Análise de tarefas por projeto, prioridade, status, categoria e tempo de execução</p>
              </div>

              <div>
                <p className="mb-2">Importante</p>
                <p>Cada função possui um artigo específico com o passo a passo detalhado de uso.</p>
              </div>
            </div>
