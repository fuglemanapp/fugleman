...
export default function AjudaArtigoNotasPage() {
  return (
      ...
      <main className="flex-1 p-4 md:p-8 flex flex-col items-center">
        ...
        <div className="w-full max-w-4xl flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3 theme-text-secondary text-xs font-medium px-2 py-4 mb-2">
            ...
            <span>{'>'}</span>
            <span className="theme-text-primary font-bold">Como usar as Notas?</span>
          </div>
          ...
          <div className="theme-bg-card rounded-[2rem] p-8 md:p-12 shadow-sm border theme-border transition-colors duration-300">
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold theme-text-primary mb-12 tracking-tight">Como usar as Notas?</h1>

            <div className="space-y-8 theme-text-secondary text-[15px] leading-relaxed">
              <p>Como usar as Notas?</p>

              <div>
                <p className="font-bold theme-text-primary text-base mb-1">Resposta rápida:</p>
                <p>Crie anotações livres e, quando quiser, transforme em tarefas com um clique.</p>
              </div>

              <div>
                <p className="mb-2">Como usar</p>
                <p>Vá em <span className="font-bold theme-text-primary">Organização &gt; Notas</span></p>
                <p>Crie uma nova nota e escreva normalmente</p>
                <p>Quando quiser, clique em <span className="font-bold theme-text-primary">Transformar em tarefa</span></p>
              </div>

              <div>
                <p className="mb-2">O que você pode definir</p>
                <p><span className="font-bold theme-text-primary">Projeto</span></p>
                <p><span className="font-bold theme-text-primary">Categoria</span></p>
              </div>

              <div>
                <p className="mb-2">Para que serve</p>
                <p>Anotar ideias rapidamente</p>
                <p>Converter anotações em tarefas sem reescrever</p>
              </div>

              <div>
                <p className="mb-2">Observação</p>
                <p>Ao converter, a nota vira uma tarefa — revise antes de confirmar</p>
              </div>
            </div>
