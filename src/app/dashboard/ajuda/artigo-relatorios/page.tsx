...
export default function AjudaArtigoRelatoriosPage() {
  return (
      ...
      <main className="flex-1 p-4 md:p-8 flex flex-col items-center">
        ...
        <div className="w-full max-w-4xl flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3 theme-text-secondary text-xs font-medium px-2 py-4 mb-2">
            ...
            <span>{'>'}</span>
            <span className="theme-text-primary font-bold">Como usar os relatórios da organizaçã...</span>
          </div>
          ...
          <div className="theme-bg-card rounded-[2rem] p-8 md:p-12 shadow-sm border theme-border transition-colors duration-300">
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold theme-text-primary mb-12 tracking-tight">Como usar os relatórios da organização?</h1>

            <div className="space-y-8 theme-text-secondary text-[15px] leading-relaxed">
              <p>Como usar os relatórios da organização?</p>

              <div>
                <p className="font-bold theme-text-primary text-base mb-1">Resposta rápida:</p>
                <p>Acesse os relatórios, escolha o tipo e exporte em PDF ou Excel (CSV).</p>
              </div>

              <div>
                <p className="mb-2">Como acessar</p>
                <p>Vá em <span className="font-bold theme-text-primary">Organização &gt; Relatórios</span></p>
                <p>Escolha o tipo de relatório</p>
                <p>Defina o período (se aplicável)</p>
              ...
              <div>
                <p className="mb-2">Tipos de relatórios</p>
                <p><span className="font-bold theme-text-primary">Por Projeto</span></p>
                <p className="mb-2">Mostra volume de tarefas em cada projeto</p>
                <p><span className="font-bold theme-text-primary">Por Prioridade</span></p>
                <p className="mb-2">Distribui tarefas entre baixa, normal e alta</p>
                <p><span className="font-bold theme-text-primary">Por Status</span></p>
                <p className="mb-2">Mostra tarefas pendentes, concluídas e atrasadas</p>
                <p><span className="font-bold theme-text-primary">Por Categoria</span></p>
                <p className="mb-2">Agrupa tarefas por categoria (tags)</p>
                <p><span className="font-bold theme-text-primary">Lead Time & Ciclo</span></p>
                <p>Tempo médio de conclusão das tarefas</p>
              </div>

              <div>
                <p className="mb-2">Observações</p>
                <p>O resultado depende dos dados cadastrados (sem tarefas, sem relatório)</p>
                <p>Períodos incorretos podem retornar vazio</p>
              </div>

              <div>
                <p className="mb-2">Resultado</p>
                <p>Arquivo gerado com base nos filtros escolhidos (PDF ou CSV)</p>
              </div>

              <div>
                <p className="mb-2">Se não funcionar</p>
                <p>Verifique se há tarefas no período</p>
                <p>Revise filtros aplicados</p>
              </div>

              <div className="pt-4">
                <p>Se persistir: envie um e-mail para contato@meuassessor.com</p>
              </div>
            </div>
