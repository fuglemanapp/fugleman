    ...
    <div className="flex flex-col min-h-screen bg-transparent transition-colors duration-300 dark:bg-[#0B0F19] font-sans text-slate-900">
      ...
      <main className="flex-1 p-4 md:p-8 overflow-auto flex flex-col items-center">
        ...
        <div className="w-full max-w-5xl bg-white rounded-2xl shadow-sm border border-slate-100 p-6 md:p-8 mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl md:text-2xl font-extrabold text-slate-900 mb-1">Minhas Integrações</h1>
            <p className="text-sm text-slate-500">Gerencie suas conexões Open Finance com bancos e cartões.</p>
          </div>
          <button
        ...
        <div className="w-full max-w-5xl flex flex-col items-center justify-center py-20 text-center">
          <div className="relative w-24 h-24 bg-gradient-to-br from-pink-100/50 to-purple-100/50 rounded-full flex items-center justify-center mb-8 shadow-sm">
            ...
            {/* Ícone de Plugue */}
            <svg className="w-10 h-10 text-purple-500 relative z-10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22v-5"></path><path d="M9 8V2"></path><path d="M15 8V2"></path><path d="M18 8v5a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V8Z"></path></svg>
          </div>
          <h2 className="text-2xl font-extrabold text-slate-900 mb-3 tracking-tight">Nenhuma integração ativa</h2>
          <p className="text-[15px] text-slate-500 max-w-[320px] mx-auto mb-8 leading-relaxed">
            Conecte suas contas bancárias e cartões de crédito para sincronizar automaticamente suas transações.
          </p>
          <button
