...
export function GoogleCalendarIntegration() {
  ...
  async function connect() {
    ...
    const result = await signIn("google", { callbackUrl: "/dashboard/agenda/integracoes" }, {
    ...
    if (result?.error) {
      setMessage("Não foi possível iniciar a conexão com o Google Calendar. Verifique as credenciais do Google no projeto.");
